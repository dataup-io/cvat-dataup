...
class JobWriteSerializer(WriteOnceMixin, serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        # Check if job stage is changing
        ...
        if stage_changing:
            if (
                ...
                and stage == models.StageChoice.VALIDATION
            ) or (
                instance.stage == models.StageChoice.VALIDATION
                and stage == models.StageChoice.ACCEPTANCE
            ):
...
class TaskWriteSerializer(WriteOnceMixin, serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        if (
            ...
            and validated_data["assignee_id"] != instance.assignee_id
        ):
