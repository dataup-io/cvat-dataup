    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(
                blank=True,
                help_text="Organization this key belongs to (leave empty for user-scoped key)",
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
                related_name="api_keys",
                to="dataup.datauporganization",
            ),
        ),
        migrations.AlterField(
            model_name="dataupapikey",
            ...
            field=models.ForeignKey(
                blank=True,
                help_text="User this key belongs to (leave empty for org-scoped key)",
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
                related_name="api_keys",
                to="dataup.dataupuser",
            ),
        ),
        migrations.AddIndex(
            model_name="dataupapikey",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                condition=models.Q(("default", True), ("owner__isnull", False)),
                fields=("owner",),
