...
DATAUP_BASE_URL = os.getenv("DATAUP_BASE_URL", "http://host.docker.internal:8001")
DATAUP_API_VERSION = os.getenv("DATAUP_API_VERSION", "v1")
...
RQ_QUEUES = {
    ...
    CVAT_QUEUES.AGENT_AUTO_ANNOTATE.value: {
        **REDIS_INMEM_SETTINGS,
        "DEFAULT_TIMEOUT": "24h",
    },
    CVAT_QUEUES.AGENT_EVALUATE.value: {
        **REDIS_INMEM_SETTINGS,
        "DEFAULT_TIMEOUT": "24h",
    },
