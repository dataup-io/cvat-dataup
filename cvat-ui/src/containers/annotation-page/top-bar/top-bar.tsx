...
import { FramesMetaData, Job, JobStage } from 'cvat-core-wrapper';
import {
    CombinedState,
    FrameSpeed,
    Workspace,
...
interface DispatchToProps {
    ...
    onSubmitJob(jobInstance: Job): Promise<boolean>;
}
...
function mapDispatchToProps(dispatch: any): DispatchToProps {
    return {
        ...
        onSubmitJob(jobInstance: Job): Promise<boolean> {
            ...
            } else if (jobInstance.stage === JobStage.VALIDATION) {
            ...
            return dispatch(updateJobAsync(jobInstance, { stage: nextStage, state }))
                .then(() => completed)
                .catch((error: any) => {
                    throw error;
                });
