...
function renderInputElement(parameters: InputElementParameters): JSX.Element {
    ...
    useEffect(() => {
        if (inputType === 'text' && localAttrValue) {
            const rtlRegex = /[\u0591-\u07FF\uFB1D-\uFDFD\uFE70-\uFEFC]/;
            const direction = rtlRegex.test(localAttrValue) ? 'rtl' : 'ltr';
            setTextDirection(direction);
        }
    }, [localAttrValue, inputType]);
    ...
    const renderText = (): JSX.Element => (
        <>
            ...
            <div className='attribute-annotation-sidebar-attr-elem-wrapper'>
                <div className='attribute-annotation-text-container'>
                    <Input.TextArea
                        autoFocus
                        ref={ref}
                        key={`${clientID}:${attrID}`}
                        ...
                        onKeyDown={handleKeydown}
                    />
                    <Space className='attribute-annotation-text-controls'>
                        <Tooltip title='Left-to-Right Text'>
                            <Button
                        ...
                        <Tooltip title='Right-to-Left Text'>
                            <Button
