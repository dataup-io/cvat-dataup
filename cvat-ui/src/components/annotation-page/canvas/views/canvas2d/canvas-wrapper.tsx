...
class CanvasWrapperComponent extends React.PureComponent<Props> {
    ...
    public componentWillUnmount(): void {
        ...
        canvasInstance.html().removeEventListener('canvas.shapedbclick', this.onCanvasShapeDbClicked);
    ...
    private onCanvasShapeDbClicked = (e: any): void => {
        const { onActivateObject } = this.props;
    ...
    private initialSetup(): void {
        ...
        canvasInstance.html().addEventListener('canvas.shapedbclick', this.onCanvasShapeDbClicked);
