...
function DataUpApiKeysPage(): JSX.Element {
    ...
    }, [CACHE_KEY, STORAGE_KEY, cacheIdentifier, message]);
        ...
        <div className="security-page" style={{ padding: '24px', maxWidth: '1200px', margin: '0 auto' }}>
            ...
            <div className="page-header" style={{ marginBottom: '24px' }}>
                <div className="header-content">
                    <Title level={2} style={{ margin: 0 }}>DataUP API Keys</Title>
                    <Text type="secondary" className="subtitle">
                        Manage your DataUP API keys for programmatic access
                    </Text>
                </div>
            ...
            {/* Empty State */}
            {(!apiKeys || apiKeys.length === 0) && !loading && (
                <Card
...
export default DataUpApiKeysPage;
